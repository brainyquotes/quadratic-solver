...
public class QuadraticFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(149, 158, 157));
        jPanel1.setPreferredSize(new java.awt.Dimension(409, 500));
        ...
        jLabel2.setText("Coefficient of X Square:");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel3.setText("Coefficient of X:");
        ...
        jLabel4.setText("Designed by: Emmanuel Nwobueze");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        //if D equals zero then the roots are real and equal
       if (D == 0){
            x1 = (-b + (Math.sqrt(D)))/(2*a);
            x2 = (-b - (Math.sqrt(D)))/(2*a);
            
            jLabel9.setText(String.valueOf(x1));
            jLabel10.setText(String.valueOf(x2));
            jLabel8.setText("");
        }
            ...
            jLabel8.setText("----YOU HAVE A COMPLEX ROOT----");
